						...
						<div class="body">
							<div class="row">
								<form:form method="post"
									action="${pageContext.request.contextPath}/admin/combo/update"
									...
									<div class="col-sm-3">
										<div class="form-group">
											...
											<div class="demo-switch">
												<div class="switch">
													<label>OFF <input name="is_available" value="${detailCombo.available}"
														 type="checkbox"
														${detailCombo.available == true ? 'checked':'' } /><span
