				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						...
						<div class="body">
							...
							<form:form
								action="${pageContext.request.contextPath}/admin/film/insert"
									...
									<div class="col-sm-3">
										<div class="form-group">
											...
											<div class="demo-switch">
												<div class="switch">
													<label>OFF <input name="_is_show" type="checkbox"
														checked /><span class="lever switch-col-blue"></span>ON
													</label>
												</div>
											</div>
										</div>
